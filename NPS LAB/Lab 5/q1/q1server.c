...
int main()
{
	...
	strcpy(stu[0].student_id,"220911009");
	strcpy(stu[1].student_id,"220911008");
	...
	strcpy(stu[0].fname,"BILLY");
	strcpy(stu[1].fname,"MANDY");
	strcpy(stu[0].lname,"ESTHER");
	strcpy(stu[1].lname,"GAMA");
